...
<html lang="en" style="font-size: 100%;">
  ...
  scroll-behavior: smooth;
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				...
				<div><a class="logo" href="index.php"><img src="images/logo.jpg" height="44px" width="60px" class="img-fluid"></a></div>
				<nav>
					<a href="#menu">Menu</a>
				</nav>
			</header>
		...
		<!-- Banner -->
			<section id="banner" style="background-image:url('images/wall.jpeg')">
				<div class="inner">
					...
					<a href="index.php">&nbsp;<img src="images/logo.jpg" height="250px" width="250px" style="opacity: 50%"></a>
				</div>
			...
			<div class = "inner" style="background-color: #f0f0f0;padding: 20px;">
				...
				<form method="POST" id="login" action="#">
			      <div class="form-group">
			        ...
			        <input type="email" id="email" type="form-control" placeholder="shankar@gmail.com" name="username" required>
			      </div>
	...
	<footer id="footer">
          <div class="copyright">
            &copy; <a href="">Shankar</a>, And <a href="">Stephens</a>.
          </div>
      </footer>
